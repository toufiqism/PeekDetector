...
android {
    namespace = "com.tofiq.peekdetector"
    compileSdk {
        version = release(36)
    }

    defaultConfig {
        applicationId = "com.tofiq.peekdetector"
        minSdk = 33
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // CameraX dependencies for easy camera access
    ...
    // Google ML Kit Face Detection dependency for the AI part
